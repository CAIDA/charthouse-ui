// Vasco: Three changes from stock:
//      * [06/02/2014] Support for AMD loading
//      * [06/02/2014] Dates converted to UTC
//      * [03/30/2015] Only use cursor keys to move head if mouse cursor is focused on graph
//      * [07/22/2015] Display null values in grey (no data)
// Alistair:
//      * [11/07/2018] Switch from AMD loading to using import/export
...
(function (exports) {
    ...
    cubism.context = function () {
        var context = new cubism_context,
            ...
            // Vasco 06/02/2014: Changed scale to UTC!!
            // Default: scale = context.scale = d3.time.scale().range([0, size]),
        ...
        d3.select(window).on("keydown.context-" + ++cubism_id, function () {
            // Vasco 03/30/2015: Only trigger cursor keys if focus is on graph
            // Default: switch (!d3.event.metaKey && d3.event.keyCode) {
    ...
    cubism_contextPrototype.librato = function (user, token) {
        ...
        var librato_request = function (composite) {
            ...
            request.fire = function (isdate, iedate, step, callback_done) {
                var a_values = [];
                /* Store partial values from librato */
        ...
        function horizon(selection) {
            ...
            selection.each(function (d, i) {
                ...
                function change(start1, stop) {
                    ...
                    // Vasco 07/22/2015: Display null values in grey (no data)
                    if (nulls) {
